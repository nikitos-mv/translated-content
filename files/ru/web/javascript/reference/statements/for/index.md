...
Следующий цикл `for` вычисляет смещение позиции узла в секции `[финальное выражение]`, и, следовательно, не требует использования инструкции или [`блока инструкций`](/ru/docs/Web/JavaScript/Reference/Statements/block) внутри цикла, вместо этого используется точка с запятой ([пустая инструкция](/ru/docs/Web/JavaScript/Reference/Statements/Empty)).
